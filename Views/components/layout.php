...
<!DOCTYPE html>
		...
		<head>
		  ...
		  <!-- Favicons -->
		  <link href="<?php echo base_url()?>public/NiceAdmin/assets/img/crystal.png" rel="icon">
		...
		<body>
		  ...
		  <script src="<?php echo base_url()?>public/NiceAdmin/assets/assets/vendor/chart.js/chart.umd.js"></script>
		  <script src="<?php echo base_url()?>public/NiceAdmin/assets/assets/vendor/echarts/echarts.min.js"></script>
