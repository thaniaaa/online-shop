...
$routes->add('/register/daftar', 'Register::daftar');
...
$routes->post('/user/edit/(:segment)', 'UserController::edit/$1', ['filter' => 'auth']);
$routes->get('/user/delete/(:segment)', 'UserController::delete/$1', ['filter'=>'auth']);
$routes->get('/profil', 'AuthController::profil', ['filter' => 'auth']);
$routes->add('/profil', 'AuthController::profil', ['filter' => 'auth']);
$routes->get('/riwayat', 'TransaksiController::history', ['filter' => 'auth']);
$routes->get('/transaksi', 'TransaksiController::process', ['filter' => 'auth']);
$routes->post('/transaksi', 'TransaksiController::process', ['filter' => 'auth']);
