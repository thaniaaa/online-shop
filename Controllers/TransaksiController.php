...
class TransaksiController extends BaseController
{
	...
	private $apiKey = "22b667ef4f61e4f9810fec375eea6554";
	...
	public function history()
	{
		...
		if (session()->get('role') == 'admin') {
			...
			$data['transactions'] = $transaksiModel->where('username', $username)->findAll();
		}
	...
	public function process()
	{
		...
		if ($this->request->getMethod() === 'post') {
			...
			// Memasukkan method POST dari page v_transaksi saat klik tombol selesai
			// Ke dalam variabel $id dan $newStatus
			$transaksiModel->update($id, ['status' => $newStatus]);
			// Update status lama dengan status yang baru
		}
